...
Route::get('/enquiry',[EnquiryController::class,'index'])->name('frontend.enquiry');
...
Route::get('/single-product/{slug}',[ProductController::class,'singlePage'])->name('frontend.single-product');

Route::post('/check-pincode', [ProductController::class, 'checkPincode'])->name('check-pincode');
...
//staff
 ...
 Route::group(['middleware' => ['auth','customer'],'prefix' => 'profile'], function () {
     ...
     Route::get('/refer-a-friend', [ProfileController::class, 'referFriend']);
     ...
     Route::get('/tracking-order-status/{order_id}', [ProfileController::class, 'trackingStatus'])->name('tracking-order-status');
 });


    Route::get('/membership-register', [UserController::class, 'index'])->name('membership-register');
    Route::post('/membershipRegi', [UserController::class, 'store'])->name('membershipRegi');
    Route::get('/membership-register/{random_string}', [UserController::class, 'getReferral'])->name('membershipRegister');
    Route::post('/membership_referral', [UserController::class, 'storeReferrals'])->name('membership-referral'); 
    Route::post('/request-fragrent', [UserController::class, 'requestFragrent'])->name('request-fragrent');

    Route::get('/phone-otp', [UserController::class, 'phoneOtp'])->name('phone-otp');
    Route::get('/confirm-otp', [UserController::class, 'confirmOtp'])->name('confirm-otp');
    Route::post('/mobile-otp-send', [UserController::class, 'confirmOtpSend'])->name('mobile-otp-send');
    Route::get('/referral-code', [UserController::class, 'referralCode'])->name('referral-code');
    Route::post('/otp-compare', [UserController::class, 'otpCompare'])->name('otp-compare');

    Route::get('/resend-otp/{mobile}',[UserController::class, 'resendOtp'])->name('resend-otp');
    
    Route::get('/load-cart-data', [UserController::class, 'loadCartData'])->name('load-cart-data');
    Route::get('/search/{q}', [UserController::class, 'search'])->name('search');

    Route::post('/review' , [UserController::class, 'reviewSubmit'])->name('review');

    Route::get('/test_otp', [UserController::class, 'sendOtpApi'])->name('test_otp');
