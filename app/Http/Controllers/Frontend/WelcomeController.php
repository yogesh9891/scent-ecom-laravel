...
class WelcomeController extends Controller
{
    ...
    {  
        try {
            ...
            $products   =  Product::with('skus')->where('is_approved',1)->get();
            $CategoryList = Category::where('parent_id', 0)->get();
            $BlogLists = BlogPost::where('is_approved', 1)->get();
            ...
            if ($previous_route != null) {
                ...
                return view(theme('welcome'), compact('CategoryList', 'widgets','BlogLists','products'));
            }
        } catch (Exception $e) {
