                ...
                <div class="product_quick_view ">
                    ...
                    <div class="product_details_wrapper">
                        <div class="product_details">
                            ...
                            <div class="details_product_price d-none">
                                ...
                                <h2 id="main_price">
                                    ...
                                    {{selling_price($product->skus->min('selling_price'),$product->hasDeal->discount_type,$product->hasDeal->discount)}}
                                    @else
                                    {{selling_price($product->skus->min('selling_price'),$product->hasDeal->discount_type,$product->hasDeal->discount)}}
                                    -
                                    {{selling_price($product->skus->max('selling_price'),$product->hasDeal->discount_type,$product->hasDeal->discount)}}
                                    ...
                                    {{selling_price($product->skus->min('selling_price'),$product->discount_type,$product->discount)}}
                                    @else
                                    {{selling_price($product->skus->min('selling_price'),$product->discount_type,$product->discount)}}
                                    -
                                    {{selling_price($product->skus->max('selling_price'),$product->discount_type,$product->discount)}}
                                    ...
                                    {{$product->skus->min('selling_price')}}
                                    @else
                                    {{$product->skus->min('selling_price')}} -
                                    {{$product->skus->max('selling_price')}}
                                    @endif
                                    @endif
                                    @endif
                                    @endif
                                </h2>
                                <span>{{$product->discount>0?$product->skus->max('selling_price'):''}}</span>
