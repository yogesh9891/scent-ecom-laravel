                                ...
                                <div class="row">
                                    <div class="col-12">
                                        ...
                                        <div class="col-12 mb_30 shipping_error">
                                            <span class="text-danger">{{$shiping_error}}</span>
                                        </div>
                                    @endif
                                                    ...
                                                    <div class="product_ceck m-0">
                                                        <ul>
                                                            <li class="mb-0">
                                                                ...
                                                                <div>
                                                                    <a>{{__('shipping.minimum_shopping_amount')}} ({{__('shipping.without_shipping_cost')}}): ₹ {{($shipping->minimum_shopping)}} </a>
                                                                </div>
                                                            </li>
                                                        </ul>
                                                    </div>
                    ...
                    <div class="order_sumery_box flex-fill">
                        ...
                        <div class="subtotal_lists">
                            ...
                            <div class="total_amount d-flex align-items-center flex-wrap">
                                <div class="single_total_left flex-fill">
                                    <span class="total_text">{{__('common.total')}} (Incl. {{__('common.vat')}}/{{__('common.tax')}}/{{__('gst.gst')}})</span>
                                </div>
