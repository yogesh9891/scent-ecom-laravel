...
@endphp
    ...
    <div id="mainDiv">
        <div class="checkout_v3_area select_payment_main">
            <div class="container">
                <div class="row">
                    <div class="col-lg-6">
                            ...
                            <div class="order_sumery_box flex-fill">
                                @if(!isModuleActive('MultiVendor'))
                                    ...
                                    @php
                                        ...
                                        // dd($total,$subtotal,$tax,$shipping_cost);
                                    @endphp
                                @endif
                                ...
                                <div class="subtotal_lists pb-5">
                                    <div class="single_total_list d-flex align-items-center">
                                        ...
                                        @else
                                        <div class="single_total_right">
                                            <span> ₹ {{($subtotal_without_discount)}}</span>
                                        </div>
                                        @endif
                                    </div>
                                    <div class="single_total_list d-flex align-items-center flex-wrap">
                                        ...
                                        <div class="single_total_right">
                                            {{-- <span>+ ₹ {{(collect($shipping_cost)->sum())}}</span> --}}
                                            Free
                                        </div>
                                    </div>
                                    @if(Auth::user()  &&  Auth::user()->is_membership)
                    ...
                    <div class="col-lg-6">
                        <div class="checkout_v3_left d-flex justify-content-start">
                                ...
                                <div class="shiping_address_box checkout_form m-0">
                                    <div class="billing_address">
                                        <div class="row">
                                                ...
                                                <div class="shipingV3_info mb_30">
                                                    <div class="single_shipingV3_info d-flex align-items-start">
                                                        ...
                                                        <h5 class="m-0 flex-fill">
                                                            @if(auth()->check())
                                                                {{auth()->user()->email != null?auth()->user()->email : auth()->user()->phone}} , &nbsp;&nbsp; {{$address->phone}}
                                                            @else
                                                                {{$address->email}}
                                                            @endif
                                                        </h5>
                                                    ...
                                                    @if(!isModuleActive('MultiVendor'))
                                                        ...
                                                        {{-- @if(!$delivery_info || $delivery_info && $delivery_info['delivery_type'] == 'home_delivery')
                                                            <div class="single_shipingV3_info d-flex align-items-start">
                                                                ...
                                                                <h5 class="m-0 flex-fill">{{$selected_shipping_method->method_name}} dssdsdsdsdd -₹ {{($shipping_cost)}}</h5>
                                                                <a href="{{url()->previous()}}" class="edit_info_text">{{__('common.change')}}</a>
                                                            </div>
                                                        @else
                                                            <div class="single_shipingV3_info d-flex align-items-start">
                                                                <span>{{__('common.method')}}</span>
                                                                <h5 class="m-0 flex-fill">Collect from pickup location -₹ {{(0)}}</h5>
                                                                <a href="{{url()->previous()}}" class="edit_info_text">{{__('common.change')}}</a>
                                                            </div>
                                                        @endif --}}
                                                    @endif
                                            ...
                                            <div class="col-12">
                                                <div id="accordion" class="checkout_acc_style1 mb_30 hideaccrdionbody" >
                                                    {{-- {{dd($gateway_activations, "gateway activation")}} --}}
                                                    @foreach($gateway_activations as $key => $payment)
                                                        ...
                                                        <div class="card">
                                                            ...
                                                            <div id="collapse{{$key}}" class="collapse" aria-labelledby="heading{{$key}}" data-parent="#accordion">
                                                                <div class="card-body mainbodyhideaccrodion">
                                                                    <div class="row">
                                                                        ...
                                                                        @elseif($payment->method == 'Wallet')
                                                                            <div class="col-lg-12 text-center mt_5 mb_25">
                                                                                <strong>{{__('common.balance')}}: ₹ {{(auth()->user()->CustomerCurrentWalletAmounts)}}</strong>
                                                                                <br>
                                                                                <span></span>
                                                                            </div>
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-12">
                                                        <div class="check_v3_btns flex-wrap d-flex align-items-center">
                                                            ...
                                                            @else
                                                                @if(!$delivery_info || $delivery_info && $delivery_info['delivery_type'] == 'home_delivery')
                                                                    <a href="{{url()->previous()}}" class="return_text">{{__('Return To Checkout')}}</a>
                                                                @else
                                                                    <a href="{{url()->previous()}}" class="return_text">{{__('defaultTheme.return_to_information')}}</a>
                                                                @endif
                                                            @endif
