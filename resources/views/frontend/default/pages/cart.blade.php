...
@section('styles')
    <link rel="stylesheet" href="{{asset(asset_path('frontend/default/css/cart.css'))}}" />
@endsection
        ...
        (function($){
            ...
            $(document).ready(function(){
                ...
                $(document).on('click', '.change_qty', function(event){
                    ...
                    if(stock_manage != '0'){
                        if(type === '+'){
                             pre_qty = parseInt(cahnge_qty) + parseInt(old_qty);
                            if(max_qty != ''){
                                if (parseInt(pre_qty) <= parseInt(product_stock)) {
                                    if(parseInt(pre_qty) <= parseInt(max_qty) ){
                                        console.log(pre_qty);
                                        $('#total_price_'+cart_id).text(pre_qty*price)
                                        $(qty_id).val(pre_qty);
                                    }else{
                             ...
                             pre_qty = parseInt(old_qty) - parseInt(cahnge_qty);
                            if(min_qty != ''){
