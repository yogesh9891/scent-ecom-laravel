...
<section class="dashboard_part padding_top" style="background-color: #fafafa">
    <div class="container">
                            ...
                            <div class="order_details">
                                    ...
                                    <div class="single_order_part">
                                         ...
                                         <div class="order_details_iner">
                                            <div class="order_item line_right_bottom">
                                                <div class="row"> 
                                                <div class="col-lg-6 order_details_status">
                                                    <ul class="w-100">
                                                        <li>  
                                                            <p><span>{{__('common.order_id')}}</span> : {{ $order->order_number }}</p>
                                                            <p><span>{{__('defaultTheme.order_date')}}</span> : {{ $order->created_at }}</p>
                                                            <p><span>{{__('Tracking Id (Waybill No)')}}</span> : {{ $order->waybill_ref }}</p>
                                                        </li>
                                                    </ul>
                                                </div>
                                                <div class="col-lg-6 order_details_status">
                                            ...
                                            <div class="order_details_btn radious_btn10">
                                                <a href="{{ route('frontend.my_purchase_order_pdf', encrypt($order->id)) }}" class="btn_1 nowrap">{{__('defaultTheme.download_invoice')}}</a>
                                            </div>
                                         </div>
                                         {{-- {{dd($order , "order order")}} --}}
                                         <div class="order_details_iner">
                                                         ...
                                                         @else
                                                             <div class="single_order_item">
                                                                 <div class="order_item_name">
                                                                     ...
                                                                     {{-- {{dd("DDDDDDDDDDD")}} --}}
                                                                {{-- {{dd($package_product, "package_product")}} --}}
                                                                     @if( $package_product->seller_product_sku && @$package_product->seller_product_sku->sku->product->product_type == 2)
                                                                     <br>
                                                                    <p>
                                             ...
                                             {{-- {{dd($order->waybill_ref)}} --}}
                                                ...
                                                @if ($order->is_confirmed == 0) 
                                                    ...
                                                    @endif
                                                @else
                                                  <a  class="btn_2 " style="cursor: not-allowed">{{__('defaultTheme.cancel_order')}}</a>
                                                @endif
                                             </div>
                                         </div>
                                     </div>
                                     ...
                                     <div class="single_order_part">
                                         <div class="order_details_status">
                                             <ul class="w-100">
                                                 ...
                                                 <li>
                                                     <p><span>{{__('defaultTheme.order_amount')}}:</span>:₹ {{ ($no_paid_order->grand_total) }}</p>
                                                 </li>
                                             </ul>
                                         </div>
                                         <div class="order_details_iner">
                                     ...
                                     <div class="single_order_part">
                                         <div class="order_details_status">
                                             <ul class="w-100">
                                                 ...
                                                 <li>
                                                     <p><span>{{__('defaultTheme.order_amount')}}</span>:₹ {{ ($order_package->order->grand_total) }}</p>
                                                 </li>
                                             </ul>
                                         </div>
                                         <div class="order_details_iner">
