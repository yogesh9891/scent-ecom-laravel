        ...
        <div class="row justify-content-center">
            ...
            <div class="col-lg-8 col-xl-9 col-md-7">
                <div class="account_details">
                     <ul class="nav nav-tabs amazcart_tabs justify-content-center mb-3" id="myTab" role="tablist">
                         <li class="nav-item">
                     ...
                     <div class="tab-content" >
                         ...
                         <div class="tab-pane fade" id="Addresses" role="tabpanel" aria-labelledby="Addresses-tab">
                            <div class="rechnagesaddress mt-4">
                                <div class="row align-items-center mb-4">
                                    <div class="col-lg-6 col-md-6 col-sm-6">
                                        <h2>Saved Addresses</h2>
                                    </div>
                                    <div class="col-lg-6 col-md-6 col-sm-6 text-right">
                                        {{-- <button class="btn_1 add_new_address"> <i class="fa fa-plus" aria-hidden="true"></i>
                                               {{__('common.add_new')}} {{__('common.address')}}</button> --}}
                                    </div>
                                </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-12">
                                        <div class="addressAccordian-addressAccordian">
                                            <div class="padibg15 edit_section_show">
                                            <div class="flex_heading_row">
                                            ...
                                            <div class="readdres_info_air">
                                                <p>{{$address->getCity->name}}</p>
                                                <p>{{$address->getState->name}}</p>
                                                <p>{{$address->getCountry->name}}</p>
                                                <p class="mb-2">Pin Code : {{$address->postal_code}}</p>
                                                <p class="addressAccordian-mobile">Mobile : {{$address->phone}}</p>
                                                <p class="addressAccordian-mobile">Email : {{$address->email}}</p>
                                            </div>
                                        </div>
                                        ...
                                        <div class="edit_section">
                                            <div class="row">
                                                <div class="col-lg-6 col-sm-6 col-md-6 text-center">
                                                    <div class="edit_add  ">
                                                        <a href="#" class="edit_address" data-id="{{$address->id}}">  EDIT </a>
                                                    </div>
                                                </div>
                                                
                                                <div class="col-lg-6 col-sm-6 col-md-6 text-center">
                                                    <div class="remove_add delete_address_btn" data-id="{{$address->id}}">
                                                        REMOVE
                                                    </div>
                                                </div>
                                            </div>
                                    ...
                                    <div class="col-lg-12">
                                        <div class="addressAccordian-addressAccordian">
                                            ...
                                            <div class="readdres_info_air">
                                                ...
                                                <p>Saraswati Vihar</p>
                                                <p>Delhi - 110086</p>
                                                <p class="mb-2">Delhi</p>
                                                <p class="addressAccordian-mobile">Mobile: 9865475236</p>
                                                <p class="addressAccordian-mobile">Email: test@gmail.com</p>
                                            </div>
                                        </div>
                                        ...
                                        <div class="edit_section">
                                            <div class="row">
                                                <div class="col-lg-6 col-sm-6 col-md-6 text-center">
                                                    <div class="edit_add  ">
                                                        <a href="#" class="edit_address" data-id="21">  EDIT </a>
                                                    </div>
                                                </div>
                                                <div class="col-lg-6 col-sm-6 col-md-6 text-center">
                         ...
                         {{--    <div class="col-lg-11 pt-3">
                                    <div class="form-group">
                                        @if($user_info->random_string)
                                            <span>My Referral URL</span>
                                            <input type="text" class="form-control readonly" name="" value="{{url('/').'/membership-register/'.$user_info->random_string}}">
                                        @endif
                                    </div>
 --}}                                </div>
                            <!-- <form action="{{route('frontend.locale')}}" name="basic_info" method="POST">
                               @csrf
                                <div class="row">
                                    ...
                                    {{-- {{dd(url('/').'/membership-register/'.$user_info->random_string)}} --}}
