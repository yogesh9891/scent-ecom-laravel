        ...
        <div class="row justify-content-center align-items-center">
            ...
            <div class="col-lg-6 col-xl-4">
                ...
                <div class="register_form_iner">
                    <h2> {{ __('defaultTheme.welcome_back') }}, <br>Please Login To Your Account</h2>
                    <form method="POST" class="register_form" name="login" action="{{ route('login') }}" id="login_form">
                        ...
                        <div class="form-row">
                            <div class="col-md-12 input_div_mb">
                                ...
                                <input type="text" id="text" name="login" value="{{ old('login') }}" class="@error('email') is-invalid @enderror">
                            ...
                            <div class="col-md-6 col-6">
                            <a href="{{url('/password/reset')}}" class="forgot_pass_btn">{{ __('Forgot Password ?') }}</a>
                            </div>

                            <div class="loring_txt text-right col-lg-12"><a href="{{route('phone-otp')}}"> Login With Phone Number </a></div>


                            <div class="col-md-12 text-center mt-3">
                                <div class="register_area">
                                    <button type="submit" class="btn-full btn-link" id="submit_btn" >{{ __('defaultTheme.login') }}</button>
                                    {{-- <div>
                                    ...
                                    <p class="mt-3"><span style="display:unset">{{ __('defaultTheme.new_member') }}</span> <a href="{{url('/register')}}" style="color:#ba933e; font-weight:600">{{ __('Create Account') }}</a> {{ __('common.here') }}</p>
                                </div>
                            </div>
                        </div>
                    </form>
