...
<section class="admin-visitor-area up_st_admin_visitor">
    <div class="container-fluid p-20 white_box">
        <form action="{{ route('product.store') }}" method="POST" enctype="multipart/form-data" id="choice_form">
                        ...
                        <div class="col-lg-8">
                            <div class="white_box pt-0 box_shadow_white mb-20 p-15">
                                <div class="row">
                                    ...
                                    <div class="col-lg-6 sku_single_div">
                                        <div class="primary_input mb-15">
                                            ...
                                            <input class="primary_input_field" name="product_sku" id="sku_single"
                                                placeholder="{{ __('product.product_sku') }}" type="text" value="{{Str::random(10)}}">
                                    ...
                                    <div class="col-lg-6 @if(!app('general_setting')->product_subtitle_show) d-none @endif">
                                        <div class="primary_input mb-15">
                                            <label class="primary_input_label" for=""> {{ __('Enter ML for Single Product') }}</label>
                                            <input class="primary_input_field" name="single_ml" id="single_ml"
                                                placeholder="{{ __('Enter ML for Single Product') }}" type="text" value="{{old('single_ml')}}">
                                            <span id="error_single_ml" class="text-danger">{{ $errors->first('single_ml') }}</span>
                                        </div>
                                    </div>
                                    <div class="col-lg-3">
                                        <div class="primary_input mb-15">
                                    ...
                                    <div class="col-lg-3">
                                        <div class="primary_input mb-15">
                                            <label class="primary_input_label" for="gender">
                                                {{ __('Gender') }}<span class="text-danger"> *</span></label>
                                            <select name="gender" class="primary_select mb-15">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-6 selling_price_div">
                                        <div class="primary_input mb-15">
                                            <label class="primary_input_label" for=""> {{ __('vip member price') }}
                                                <span class="text-danger"></span></label>
                                            <input class="primary_input_field selling_price" name="vip_member_price" id="vip_member_price"
                                                placeholder="{{ __('vip member price') }}" type="number" min="0"
                                                step="{{step_decimal()}}" value="{{old('vip_member_price')?old('vip_member_price'):0}}">
                                            <span class="text-danger" id="error_vip_member_price">{{ $errors->first('vip_member_price') }}</span>
                                        </div>
                                    </div>
 
            <div class="col-lg-6" id="gst_list_div">                  
                <div class="primary_input">
                    <label class="primary_input_label" for="">{{ __('Enable Member Status') }}</label>
                    <ul id="theme_nav" class="permission_list sms_list ">
                        <li>
                            <label data-id="bg_option" class="primary_checkbox d-flex mr-12">
                                <input name="vip_status" id="status_active" value="1" class="active"
                                    type="radio">
                                <span class="checkmark"></span>
                            </label>
                        ...
                        <li>
                            <label data-id="color_option" class="primary_checkbox d-flex mr-12">
                                <input name="vip_status" value="0" id="status_inactive" class="de_active" checked="true" type="radio">
                                <span class="checkmark"></span>
                            </label>
            ...
            <div class="col-lg-6" id="gst_list_div">                  
                <div class="primary_input">
                    <label class="primary_input_label" for="">{{ __('Check To Enable Member Product') }}</label>
                    <ul id="theme_nav" class="permission_list sms_list ">
                        <li>
                            <label data-id="bg_option" class="primary_checkbox d-flex mr-12">
                                <input name="vip_product" id="status_active" value="1" class="active"
                                    type="radio">
                                <span class="checkmark"></span>
                            </label>
                            <p>{{ __('common.active') }}</p>
                        ...
                        <li>
                            <label data-id="color_option" class="primary_checkbox d-flex mr-12">
                                <input name="vip_product" value="0" id="status_inactive" class="de_active" checked="true" type="radio">
                                <span class="checkmark"></span>
                            </label>
                            <p>{{ __('common.inactive') }}</p>
                        </li>
                    ...
                    <span class="text-danger" id="status_error"></span>
                                    ...
                                    <div class="col-lg-6 selling_price_div">
                                        <div class="primary_input mb-15">
                                            <label class="primary_input_label" for=""> {{ __('Trending New Tag') }}
                                                <span class="text-danger"></span></label>
                                            <input class="primary_input_field selling_price" name="new_tag" id="new_tag"      type="date" step="{{step_decimal()}}" value="{{old('new_tag')?old('new_tag'):0}}">
                                            <span class= "text-danger" id="error_new_tag">{{ $errors->first('new_tag') }}</span>
                                        </div>
                                    </div>
                                    
                                    <div class="col-lg-12">
                                        <div class="main-title d-flex">
                                            <h3 class="mb-3 mr-30">{{ __('Product Detail') }}</h3>
                                        </div>
                                    </div>
                                    <div class="col-lg-12">
                                        <div class="primary_input mb-15">
                                    ...
                                    <div class="col-lg-12">
                                        <div class="main-title d-flex">
                                            <h3 class="mb-3 mr-30">{{ __('Product Description') }}</h3>
                                        </div>
                                    </div>
                                    <div class="col-lg-12">
                                        <div class="primary_input mb-15">
