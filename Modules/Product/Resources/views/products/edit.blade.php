            ...
            <form action="{{ route('product.update', $product->id) }}" method="POST" enctype="multipart/form-data"
                                ...
                                <div class="white_box_50px box_shadow_white mb-20 pt-0 p-15">
                                        ...
                                        <div class="col-lg-6 @if(!app('general_setting')->product_subtitle_show) d-none @endif">
                                            <div class="primary_input mb-15">
                                                ...
                                                <input class="primary_input_field" name="single_ml" id="single_ml"
                                                    placeholder="{{ __('Enter ML for Single Product') }}" type="text" value="{{old('single_ml')?old('single_ml'):$product->single_ml}}">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-lg-6 selling_price_div">
                                            <div class="primary_input mb-15">
                                                <label class="primary_input_label" for="">
                                                    {{ __('vip member price') }} <span
                                                    class="text-danger"></span></label>
                                                <input class="primary_input_field selling_price" name="vip_member_price" id="selling_price"
                                                    placeholder="{{ __('vip member price') }}" type="number" min="0"
                                                    step="{{step_decimal()}}" value="{{ @$product->skus->first()->vip_member_price }}"
                                                    >
                                                <span class="text-danger" id="error_selling_price">{{ $errors->first('selling_price') }}</span>
                                            </div>
                                        </div>
                ...
                <div class="primary_input">
                    ...
                    <ul id="theme_nav" class="permission_list sms_list ">
                        <li>
                            <label data-id="bg_option" class="primary_checkbox d-flex mr-12">
                                <input name="vip_status" id="status_active" value="1" class="active"
                                    type="radio" @if ($product->skus->first()->vip_status == 1) checked @endif>
                                <span class="checkmark"></span>
                            </label>
                        ...
                        <li>
                            <label data-id="color_option" class="primary_checkbox d-flex mr-12">
                                <input name="vip_status" value="0" id="status_inactive" class="de_active" type="radio" @if ($product->skus->first()->vip_status == 0) checked @endif>
                                <span class="checkmark"></span>
                            </label>
                ...
                <div class="primary_input">
                    ...
                    <ul id="theme_nav" class="permission_list sms_list ">
                        <li>
                            <label data-id="bg_option" class="primary_checkbox d-flex mr-12">
                                <input name="vip_product" id="status_active" value="1" class="active"
                                    type="radio" @if ($product->skus->first()->vip_product == 1) checked @endif>
                                <span class="checkmark"></span>
                            </label>
                            <p>{{ __('common.active') }}</p>
                        </li>
                        <li>
                            <label data-id="color_option" class="primary_checkbox d-flex mr-12">
                                <input name="vip_product" value="0" id="status_inactive" class="de_active" type="radio" @if ($product->skus->first()->vip_product == 0) checked @endif>
                                <span class="checkmark"></span>
                            </label>
                            <p>{{ __('common.inactive') }}</p>
                        </li>
                ...
                <div class="col-lg-6 selling_price_div">
                    <div class="primary_input mb-15">
                        <label class="primary_input_label" for="">
                        {{ __('Trending New Tag') }} <span class="text-danger"></span></label>
                        <input class="primary_input_field new_tag" name="new_tag" id="new_tag"
                        type="date" 
                        step="{{step_decimal()}}" value="{{ @$product->skus->first()->new_tag }}">
