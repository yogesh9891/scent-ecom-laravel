                ...
                <div class="col-12">
                    <div class="box_header common_table_header">
                        <div class="main-title d-md-flex">
                            <h3 class="mb-0 mr-30 mb_xs_15px mb_sm_20px">{{ __('Edit Gender') }}</h3>
                        </div>
                    </div>
                </div>
            </div>
            <form action="{{route("product.gender.update", $gender->id)}}" method="POST" enctype="multipart/form-data">
                @csrf
                <div class="row">
                    <div class="col-lg-8">
                            ...
                            <div class="row">
                                <div class="col-lg-12">
                                    <div class="main-title d-flex">
                                        <h3 class="mb-2 mr-30">{{ __('Gender Info') }}</h3>
                                    </div>
                                </div>
                                <div class="col-lg-12">
                                    <div class="primary_input mb-15">
                                        <label class="primary_input_label" for=""> {{__("common.name")}} <span class="text-danger">*</span></label>
                                        <input class="primary_input_field" name="name" placeholder="{{__("common.name")}}" type="text" value="{{$gender->name}}">
                                        @error('name')
                                ...
                                <div class="col-lg-12">
                                    <div class="primary_input mb-15">
                                        ...
                                        <textarea class="summernote" name="description">{{$gender->description}}</textarea>
                                    </div>
                                </div>
                                {{-- <div class="col-lg-12">
                                ...
                                <div class="col-lg-12">
                                    <div class="primary_input mb-15">
                                        ...
                                        <input class="primary_input_field" name="meta_title" placeholder="{{__("common.meta_title")}}" type="text" value="{{$gender->meta_title}}">
                                ...
                                <div class="col-lg-12">
                                    <div class="primary_input mb-15">
                                        ...
                                        <textarea class="primary_textarea height_112 meta_description" placeholder="{{ __('common.meta_description') }}" name="meta_description" spellcheck="false">{{$gender->meta_description}}</textarea>
                    ...
                    <div class="col-lg-4">
                        <div class="white_box_50px box_shadow_white">
                            <div class="row">
                                ...
                                <div class="col-lg-12">
                                    <div class="primary_input mb-25">
                                        ...
                                        <select class="primary_select mb-25" name="status" id="status">
                                            <option value="1" @if ($gender->status == 1) selected @endif>{{ __('common.publish') }}</option>
                                            <option value="0" @if ($gender->status == 0) selected @endif>{{ __('common.pending') }}</option>
                                        </select>
                                        @error('status')
                                        <span class="text-danger">{{$message}}</span>
                                        @enderror
                                ...
                                <div class="col-lg-5">
                                    <div class="logo_div">
                                        <img id="logoImg" src="{{ showImage($gender->logo?$gender->logo:'backend/img/default.png') }}" alt="">
                                    </div>
                                </div> --}}
                                {{-- <div class="col-lg-12">
                                    <div class="primary_input mb-25">
                                ...
                                <div class="col-lg-12">
                                    <div class="primary_input mb-30">
                                        <label class="switch_toggle" for="active_checkbox1">
                                            <input type="checkbox" id="active_checkbox1" name="featured" @if ($gender->featured == 1) checked @endif>
