...
Route::prefix('products')->as('product.')->group(function() {
    ...
    Route::middleware(['auth','admin'])->group(function() {
        Route::get('/gender-list', 'GenderController@index')->name('gender.index')->middleware(['permission']);
        Route::get('/gender-create', 'GenderController@create')->name('gender.create')->middleware(['permission']);
        Route::post('/gender-store', 'GenderController@store')->name('gender.store')->middleware('prohibited_demo_mode');
        Route::get('/gender-edit/{id}', 'GenderController@edit')->name('gender.edit')->middleware(['permission']);
        Route::post('/gender-update/{id}', 'GenderController@update')->name('gender.update')->middleware('prohibited_demo_mode');
        Route::get('/gender-destroy/{id}', 'GenderController@destroy')->name('gender.destroy')->middleware(['permission','prohibited_demo_mode']);
        Route::post('/genders-update-status', 'GenderController@update_status')->name('gender.update_active_status')->middleware(['permission','prohibited_demo_mode']);
        Route::post('/genders-update-feature', 'GenderController@update_feature')->name('gender.update_active_feature')->middleware(['permission','prohibited_demo_mode']);
        Route::post('/genders/menu/update-order','GenderController@updateOrder')->name('gender.menuOrder')->middleware('prohibited_demo_mode');
        Route::post('/genderspost-sortable','GenderController@sortableUpdate')->name('abc');
        Route::post('load-more-gender', 'GenderController@load_more_genders')->name('load_more_genders')->middleware(['permission']);
        Route::get('bulk-gender-upload', 'GenderController@bulk_gender_upload_page')->name('bulk_gender_upload_page')->middleware(['permission']);
        Route::post('bulk-gender-upload-store', 'GenderController@bulk_gender_store')->name('bulk_gender_store')->middleware(['permission','prohibited_demo_mode']);
        Route::get('download-gender-list-csv', 'GenderController@csv_gender_download')->name('csv_gender_download')->middleware(['permission']);
    });
