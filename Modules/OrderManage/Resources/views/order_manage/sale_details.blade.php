                        ...
                        <div class="white_box_50px box_shadow_white" id="printableArea">
                            <div class="row pb-30 border-bottom">
                                ...
                                <div class="col-md-6 col-lg-6 text-right">
                                    ...
                                    <h4>Tracking Id : {{ $order->waybill_ref }}</h4>
                                    <button class="form-control" id="trackingStatus">Order Tracking Status</button>
                                </div>
                                ...
                                <div class="col-md-12 col-lg-12">
                                    <table class="table-borderless clone_line_table w-100">
                                        ...
                                        <tr>
                                            ...
                                            <td class="pl-25 text-nowrap">: {{ $order->is_paid == 1 ? __('common.yes') : __('C.O.D') }}</td>
                                        </tr> --}}
                                    ...
                                    <div class="col-lg-12 p-0">
                                        <div class="primary_input mb-25">
                                            ...
                                            <select class="primary_select mb-25" name="is_confirmed" id="is_confirmed">
                                                ...
                                                @else
                                                    <option value="0" @if ($order->is_confirmed == 0) selected @endif>{{ __('placed') }}
                                                    </option>
                                                    <option value="1" @if ($order->is_confirmed == 1) selected @endif>{{ __('order.confirmed') }}
                                                    </option>
                                    ...
                                    <div class="col-lg-12 p-0" style="display:none;">
                                        <div class="primary_input mb-25">
                                            ...
                                            <select class="primary_select mb-25" name="is_paid" id="is_paid">
                                                <option value="0" @if ($order->is_paid == 0) selected @endif>{{ __('placed') }}</option>
                                    ...
                                    <div class="col-lg-12 p-0" style="display:none;">
                                        <div class="primary_input mb-25">
                                            ...
                                            <select class="primary_select mb-25" name="is_completed" id="is_completed">
                                                <option value="0" @if ($order->is_completed == 0) selected @endif>{{ __('placed') }}</option>
...
@push('scripts')
    ...
    $('#trackingStatus').click(function(e) {  
        ...
        $.ajax({
            type: "GET",
            url: "{{route('tracking-status',$order->waybill_ref)}}",
