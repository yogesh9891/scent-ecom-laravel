        ...
        <div class="row justify-content-center">
            <div class="col-md-12 mb-20">
                <div class="box_header_right">
                    <a class="form-group" style="border-radius: 30px;padding: 10px 23px;background: white;text-transform: uppercase;font-size: 12px; line-height: 16px;border: 2px solid black; color:black;" href="{{route('export-order')}}">export all order</a>
                    <div class="float-lg-right float-none pos_tab_btn justify-content-end">
                        <ul class="nav nav_list" role="tablist">
                            @if (permissionCheck('pending_orders'))
                                <li class="nav-item">
                                    <a class="nav-link active show" href="#order_placed_data" role="tab" data-toggle="tab" id="1" aria-selected="true">{{__('Placed Orders')}}</a>
                                </li>
                            @endif
            ...
            <div class="col-xl-12">
                <div class="white_box_30px mb_30">
                    ...
                    <div class="tab-content">
                        @if (permissionCheck('pending_orders'))
                            <div role="tabpanel" class="tab-pane fade active show" id="order_placed_data">
                                <div class="box_header common_table_header ">
                                    <div class="main-title d-md-flex">
                                        <h3 class="mb-0 mr-30 mb_xs_15px mb_sm_20px">{{__('Placed Orders')}}</h3>
                                    </div>
                                </div>
                                <div class="QA_section QA_section_heading_custom check_box_table">
                                    <div class="QA_table">
                                        ...
                                        <div class="" id="latest_order_div">
                                            <table class="table" id="orderPlacedTable">
                                                <thead>
                                                    <tr>
                                                        <th>{{__('common.sl')}}</th>
    ...
    <script>
        (function($){
            ...
            $(document).ready(function(){
                ...
                $('#orderPlacedTable').DataTable({
                    processing: true,
                    serverSide: true,
                    "stateSave": true,
                    "ajax": ( {
                        url: "{{ route('order_manage.total_sales_get_data') }}" + '?table=placed'
                    }),
