...
Route::prefix('ordermanage')->group(function () {
    ...
    Route::get('/ordermanage/export-order', 'OrderManageController@export')->name('export-order')->middleware(['auth']);
    Route::get('/tracking-status/{order_id}', 'OrderManageController@trackingStatus')->name('tracking-status')->middleware(['auth']);
