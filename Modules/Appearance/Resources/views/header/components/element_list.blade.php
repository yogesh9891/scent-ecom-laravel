            ...
            <div class="col-lg-12 single_item" data-id="{{$element->id}}" >
                <div class="mb-10">
                    <div class="card" id="accordion_{{$element->id}}">
                        ...
                        <div id="collapse_{{$element->id}}" class="collapse" aria-labelledby="heading_{{$element->id}}" data-parent="#accordion_{{$element->id}}">
                            <div class="card-body">
                                <form enctype="multipart/form-data" id="element_edit_form" class="element_edit_offer_form">
                                    <div class="row">
                                        <input type="hidden" name="id" value="{{$element->id}}">
                                        <input type="hidden" name="header_id" value="{{$header->id}}">
                                        <input type="hidden" id="header_type" value="{{$header->type}}">
...
<div class="white-box p-15">
        <h4 class="mb-10">{{__('appearance.offerCollection_list')}}</h4>
        <div id="offerCollectionDiv" class="minh-250">
            @if(count(@$header->offerCollectionSectionItems())>0)
            @foreach(@$header->offerCollectionSectionItems() as $key => $element)
            <div class="col-lg-12 single_item" data-id="{{$element->id}}" >
                <div class="mb-10">
                    <div class="card" id="accordion_{{$element->id}}">
                        <div class="card-header card_header_element">
                        ...
                        <div id="collapse_{{$element->id}}" class="collapse" aria-labelledby="heading_{{$element->id}}" data-parent="#accordion_{{$element->id}}">
                            <div class="card-body">
                                <form enctype="multipart/form-data" class="element_edit_offer_form">
                                    <div class="row">
                                        <input type="hidden" name="id" value="{{$element->id}}">
                                        <input type="hidden" name="header_id" value="{{$header->id}}">
                                        <input type="hidden" id="header_type" value="{{$header->type}}">
                                        ...
                                        <div class="col-lg-12">
                                            <div class="primary_input mb-25">
                                                <label class="primary_input_label"
                                                    for="name">{{__('common.description')}} <span class="text-danger">*</span></label>
                                            </div>
                                        </div>
                                        <div class="col-lg-12">
                                            <div class="primary_input mb-15">
                                                <textarea class="ckeditor" name="description">{{$element->description}}</textarea>
                                            </div>
                                        </div>

                                        <div class="col-lg-8">
                                            <div class="primary_input mb-25">
                                                <label class="primary_input_label" for="">{{ __('Offer Image') }} (660 x 365)PX <span class="text-danger">*</span></label>
                                                <div class="primary_file_uploader">
                                                    <input class="primary-input" type="text" id="banner_image_file_{{$element->id}}"
                                                        placeholder="{{__('common.browse')}} {{__('common.image')}}" readonly="">
                                                    <button class="" type="button">
                                                        <label class="primary-btn small fix-gr-bg"
                                                            for="offer_image_{{$element->id}}">{{ __('common.browse') }} </label>
                                                        <input type="file" class="d-none offer_image_edit" data-img_id="#offer_img_div_{{$element->id}}" data-name_id="#banner_image_file_{{$element->id}}" name="offer_image" id="offer_image_{{$element->id}}">
                                                    </button>
                                                </div>
                                            </div>
                                            @error('slider_image')
                                        ...
                                        <div class="col-lg-4">
                                            <div class="offer_img">
                                                <img class="offerImgDiv" height="150px" width="150px" id="offer_img_div_{{$element->id}}" src="{{ showImage($element->offer_image?$element->offer_image:'backend/img/default.png') }}" alt="">
                                            </div>
                                        </div>
                                        ...
                                        {{-- <div class="col-lg-12">
                                            <div class="primary_input mb-25">
                                                ...
                                                <select name="data_type" data-id="#data_div_{{$element->id}}" class="primary_select edit_offerCollection_drop mb-15 element_list_data_type">
                                                    <option value="">select</option>
                                                    <option {{$element->data_type == 'product'?'selected':''}} value="product">{{ __('appearance.for_product') }}</option>
                                                    <option {{$element->data_type == 'category'?'selected':''}} value="category">{{ __('appearance.for_category') }}</option>
                                                    <option {{$element->data_type == 'brand'?'selected':''}} value="brand">{{ __('appearance.for_brand') }}</option>
                                        ...
                                        <div class="col-lg-12">
                                            <div class="primary_input mb-25">
                                                <label class="primary_input_label"
                                                    ...
                                                    <input class="primary_input_field" type="text" id="url" name="url" autocomplete="off"
                                                    value="{{$element->data_type}}" placeholder="{{__('url')}}" >
                                            </div>
                                            <span class="text-danger" id="error_name"></span>
                                        </div>
            ...
            <div class="mt-20 pt-100 text-center">
                {{__('appearance.no_offerCollections')}}
            </div>
            @endif
...
<div class="white-box p-15">
        <h4 class="mb-10">{{__('clients list')}}</h4>
        <div id="clientsDiv" class="minh-250">
            @if(count(@$header->clientsSectionItems())>0)
            @foreach(@$header->clientsSectionItems() as $key => $element)
            <div class="col-lg-12 single_item" data-id="{{$element->id}}" >
                <div class="mb-10">
                    <div class="card" id="accordion_{{$element->id}}">
                        <div class="card-header card_header_element">
                                ...
                                <form enctype="multipart/form-data" class="element_edit_offer_form">
                                    <div class="row">
                                       ...
                                       {{--  <div class="col-lg-12">
                                        ...
                                        <div class="col-lg-8">
                                            <div class="primary_input mb-25">
                                                <label class="primary_input_label" for="">{{ __('clients Image') }} (660 x 365)PX <span class="text-danger">*</span></label>
                                                <div class="primary_file_uploader">
                                                    <input class="primary-input" type="text" id="banner_image_file_{{$element->id}}"
                                                        placeholder="{{__('common.browse')}} {{__('common.image')}}" readonly="">
                                                    <button class="" type="button">
                                                        <label class="primary-btn small fix-gr-bg"
                                                            for="clients_image_{{$element->id}}">{{ __('common.browse') }} </label>
                                                        <input type="file" class="d-none clients_image_edit" data-img_id="#clients_img_div_{{$element->id}}" data-name_id="#banner_image_file_{{$element->id}}" name="clients_image" id="clients_image_{{$element->id}}">
                                                    </button>
                                                </div>
                                            </div>
                                            @error('clients_image')
                                            <span class="text-danger" id="error_clients_image">{{$message}}</span>
                                            @enderror
                                        </div>

                                        <div class="col-lg-4">
                                            <div class="offer_img">
                                                <img class="clientsImgDiv" height="150px" width="150px" id="clients_img_div_{{$element->id}}" src="{{ showImage($element->clients_image?$element->clients_image:'backend/img/default.png') }}" alt="">
                                            </div>
                                        </div>

                                        {{-- <div class="col-lg-12">
                                            <div class="primary_input mb-25">
                                                <label class="primary_input_label" for="">{{ __('appearance.clients_for') }}</label>
                                                <select name="data_type" data-id="#data_div_{{$element->id}}" class="primary_select edit_clients_drop mb-15 element_list_data_type">
                                                    <option value="">select</option>
                                                    <option {{$element->data_type == 'product'?'selected':''}} value="product">{{ __('appearance.for_product') }}</option>
                                                    <option {{$element->data_type == 'category'?'selected':''}} value="category">{{ __('appearance.for_category') }}</option>
                                                    <option {{$element->data_type == 'brand'?'selected':''}} value="brand">{{ __('appearance.for_brand') }}</option>
                                        ...
                                        {{-- <div class="col-lg-12" id="data_div_{{$element->id}}">
                                                ...
                                                @elseif($element->data_type == 'brand')
                                                    ...
                                                    <div class="primary_input mb-25">
                                                        <label class="primary_input_label" for="">{{ __('product.brand_list') }}</label>
                                                        <select name="data_id" id="offerCollection_brand" class="offerCollection_brand mb-15">
                                                            <option value="{{$element->data_id}}" selected>{{@$element->brand->name}}</option>
                                                ...
                                                @elseif($element->data_type == 'tag')
                                                    ...
                                                    <div class="primary_input mb-25">
                                                        <label class="primary_input_label" for="">{{ __('common.tag') }} {{__('common.list')}}</label>
                                                        <select name="data_id" id="offerCollection_tag" class="offerCollection_tag mb-15">
                                                            <option value="{{$element->data_id}}" selected>{{@$element->tag->name}}</option>
