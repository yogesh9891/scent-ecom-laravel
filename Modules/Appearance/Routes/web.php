...
Route::middleware(['auth','admin'])->prefix('appearance')->as('appearance.')->group(function() {
    ...
    Route::get('/fragment' , 'PreloaderSettingController@getAll')->name('fragment')->middleware('permission');
    Route::get('/delete/{id}' , 'PreloaderSettingController@delete')->name('delete')->middleware('permission');

    Route::get('/product-review' , 'PreloaderSettingController@getAllReview')->name('product-review')->middleware('permission');
    Route::get('/review-delete/{id}' , 'PreloaderSettingController@deleteReview')->name('review-delete')->middleware('permission');
    Route::POST('/reviewStatus', 'PreloaderSettingController@reviewStatus')->name('review-status')->middleware('permission');;
