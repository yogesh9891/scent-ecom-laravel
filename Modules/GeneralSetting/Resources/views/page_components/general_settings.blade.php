            ...
            <div class="row">
                <div class="col-xl-12">
                    <div class="primary_input mb-25">
                        <label class="primary_input_label" for="">{{ __('general_settings.system_logo_name') }}</label>
                        <input class="primary_input_field" placeholder="{{ __('general_settings.system_logo_name') }}" type="text" id="system_logo_name" name="system_logo_name" value="{{ $setting->system_logo_name }}">
                    </div>
                </div>
                ...
                <div class="col-xl-6">
                    <div class="primary_input">
                      ...
                      <div class="col-md-12">
                    <div class="primary_input">
                        <label class="primary_input_label" for="">Membership URL </label> <a href="{{route('membership-register')}}" target="_blank">{{route('membership-register')}}</a></span>
                        <ul id="theme_nav" class="permission_list sms_list ">
                            <li>
                                <label data-id="bg_option" class="primary_checkbox d-flex mr-12 extra_width">
                                    <input name="membeship_url" id="membership_show_active" value="1" class="active" type="radio" {{(app('general_setting')->membeship_url == 1)?'checked':''}}>
                                    <span class="checkmark"></span>
                                </label>
                                <p>{{ __('common.active') }}</p>
                            </li>
                            <li>
                                <label data-id="color_option" class="primary_checkbox d-flex mr-12 extra_width">
                                    <input name="membeship_url" id="membership_show_inactive" value="0" class="de_active" type="radio" {{(app('general_setting')->membeship_url == 0)?'checked':''}}>
                                    <span class="checkmark"></span>
                                </label>
                                <p>{{ __('common.inactive') }}</p>
                            </li>
