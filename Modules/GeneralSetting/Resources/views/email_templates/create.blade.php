                            ...
                            <div class="row">
                                ...
                                <div class="col-xl-12">
                                    <div class="primary_input mb-25">
                                        ...
                                        <label class="primary_input_label red_text" for="">{GIFT_CARD_NAME}, {SECRET_CODE}, {USER_FIRST_NAME}, {USER_EMAIL}, {EMAIL_SIGNATURE}, {ORDER_TRACKING_NUMBER}, {WEBSITE_NAME}, {RESET_LINK},{VERIFICATION_LINK}, {CUSTOM_MESSAGE}</label>
                                    </div>
                                </div>
                                <div class="col-xl-12">
                                    <div class="primary_input mb-25">
