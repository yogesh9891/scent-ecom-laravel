                ...
                <div class="add-visitor">
                    ...
                    <div id="formDataDiv">
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-12">
                                <div class="primary_input mb-25">
                                    <label class="primary_input_label" for="coupon_code">{{ __('marketing.coupon_code') }} 
                            ...
                            <div class="col-lg-12">
                                <div class="primary_input mb-15">
                                    <label class="primary_input_label"
                                        ...
                                        class="text-danger">*</span></label>
                                    <select name="product_list[]" id="product_list" class="mb-15"
                                        multiple>
                                ...
                                <div class="primary_input mb-25">
                                    ...
                                    <div class="primary_input mb-25">
                                        <select class="primary_select mb-25" name="for_member" id="for_member">
                                            <option {{$coupon->for_member == 1?'selected':''}} value="1">{{ __('Yes') }}</option>
                                            <option {{$coupon->for_member == 0?'selected':''}} value="0">{{ __('No') }}</option>
                                        </select>
                                        <span class="text-danger" id="error_discount_type"></span>
                                    </div>
                                </div>
                                ...
                                <div class="primary_input mb-25">
                                    ...
                                    <div class="primary_input mb-25">
                                        <select class="primary_select mb-25" name="for_all" id="for_all">
                                            <option {{$coupon->for_all == 1?'selected':''}} value="1">{{ __('Yes') }}</option>
                                            <option {{$coupon->for_all == 0?'selected':''}} value="0">{{ __('No') }}</option>
                                        </select>
                                        <span class="text-danger" id="error_discount_type"></span>
                                    </div>
                                </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-6">
                                <div class="primary_input mb-25">
                                    <label class="primary_input_label" for="title">{{ __('For User') }} <span
                                            class="text-danger"></span></label>
                                    <div class="primary_input mb-25">
                                        <select class="primary_select mb-25" name="for_all" id="for_all">
                                            <option {{$coupon->for_all == 1?'selected':''}} value="1">{{ __('Yes') }}</option>
                        ...
                        <div class="row">
                            <div class="col-lg-12">
                                <h4 class="ml-10">{{__('add coupon based on brands')}}</h4>
                                <hr>
                            </div>
                            <div class="col-lg-12">
                                <div class="primary_input mb-25">
