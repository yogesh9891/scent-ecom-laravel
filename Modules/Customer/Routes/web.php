...
Route::prefix('customer')->group(function() {
    ...
    Route::post('/is-member-active/update','CustomerController@update_is_member_status')->name('customer.update_is_member_status')->middleware(['auth','admin','permission','prohibited_demo_mode']);
